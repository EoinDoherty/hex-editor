...
import HexEditor from '../lib/hex-editor';
...
describe('HexEditor', () => {
  ...
  describe('when the hex-view:encode event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.hex-editor')).not.toExist();

      // This is an activation event, triggering it will cause the package to be
      // activated.
      atom.commands.dispatch(workspaceElement, 'hex-view:encode');
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.hex-editor')).toExist();

        let hexEditorElement = workspaceElement.querySelector('.hex-editor');
        expect(hexEditorElement).toExist();
